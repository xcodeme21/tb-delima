  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Transaksi Kirim</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('transaksi-kirim') }}">Utama</a></li>
              <li class="breadcrumb-item active">View Transaksi Kirim</li>
            </ol>
          </div>
        </div>
      </div>
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                ...
                <div class="col-6">
                  ...
                  @if(@$rs->metode_pembayaran == 2)
                    <div class="callout callout-danger">
                      {{ Form::open(['route'=>'upload-transaksi-kirim' ,'method' => 'post', 'class'=>'form-horizontal mt-3  animated bounceIn','enctype'=>'multipart/form-data']) }} 
                      {{ Form::token() }}
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="{{ url('/backend/transaksi-kirim/view/invoice/'.@$rs->id) }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Cetak Invoice</a>
                  <a href="{{ url('/backend/transaksi-kirim/selesai/'.@$rs->id) }}" class="btn btn-success float-right"><i class="far fa-paper-plane"></i>&nbsp;Selesai
                  </a>
                </div>
              </div>
            </div>
