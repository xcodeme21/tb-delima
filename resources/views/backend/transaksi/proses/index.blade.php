        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('transaksi-proses') }}">Home</a></li>
                      ...
                      <table id="listtransaksi" class="table table-condensed display" cellspacing="0" width="100%">
                          <thead>
                              <tr>
                                  ...
                                  <th class="bg-th">Status Pengiriman</th>
                                  <th class="bg-th">Status Pembayaran</th>
                                  <th class="bg-th">Status Pengiriman</th>
...
<script>
  $(function() {
      $('#listtransaksi').DataTable({
          ...
          processing: true,
          serverSide: true,
          ajax: "{{ url('backend/transaksi-proses/data') }}",
          columns: [
