  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Transaksi Proses</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('transaksi-proses') }}">Utama</a></li>
              <li class="breadcrumb-item active">View Transaksi Proses</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="{{ url('/backend/transaksi-proses/view/invoice/'.@$rs->id) }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Cetak Invoice</a>
                  <a href="{{ url('/backend/transaksi-proses/kirim/'.@$rs->id) }}" class="btn btn-success float-right"><i class="far fa-paper-plane"></i>&nbsp;Kirim
                  </a>
                </div>
              </div>
            </div>
