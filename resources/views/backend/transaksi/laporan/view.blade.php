        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ route('laporan-transaksi') }}">Utama</a></li>
              <li class="breadcrumb-item active">View Laporan Transaksi</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="{{ url('/backend/laporan-transaksi/view/invoice/'.@$rs->id) }}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Cetak Invoice</a>
                </div>
              </div>
            </div>
            <!-- /.invoice -->
