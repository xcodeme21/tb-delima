          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                {{ Form::open(['route'=>'edit-kategori' ,'method' => 'post', 'class'=>'form-horizontal mt-3  animated bounceIn','enctype'=>'multipart/form-data']) }} 
                {{ Form::token() }}
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Kategori</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control form-control-line" name="nama_kategori" value="{{ @$rs->nama_kategori }}" placeholder="Nama Kategori" required>
