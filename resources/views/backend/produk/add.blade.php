      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                {{ Form::open(['route'=>'tambah-produk' ,'method' => 'post', 'class'=>'form-horizontal mt-3  animated bounceIn','enctype'=>'multipart/form-data']) }} 
                {{ Form::token() }}
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nama Produk</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control form-control-line" name="nama_produk" placeholder="Nama Produk" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Kategori</label>
                        <div class="col-sm-9">
                        {{ Form::select('kategori_id', @$kategori_id,null, ['class'=>'form-control form-control-line select2 select2-danger', 'data-dropdown-css-class'=>'select2-danger', 'style'=>'width: 100%;', 'required']) }}
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Keterangan</label>
                        <div class="col-sm-9">
                            <textarea class="form-control form-control-line textarea" name="keterangan_produk" placeholder="Keterangan" required></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control form-control-line" id="rupiah" name="harga" placeholder="0" required">
                          </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="file" class="form-control form-control-line" name="foto_produk" placeholder="Foto" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Stok</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control form-control-line" name="stok" placeholder="Stok" required>
                        </div>
                    </div>
